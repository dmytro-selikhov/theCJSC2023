...
console.log(Math.trunc(Math.random() * 6) + 1); // random value between 1 - 6
...
console.log(+future);
const calcDaysPassed = (date1, date2) => Math.abs((date2 - date1) / (1000 
  * 60 * 60 * 24));
